...
- [ ] 1. Set up project foundation and core types
  - [ ] 1.1 Clean the existing src/ directory and set up fresh project structure
  ...
  - [ ] 1.2 Define all TypeScript interfaces and types
  ...
  - [ ] 1.3 Set up Supabase client and test configuration
...
- [ ] 2. Implement Supabase schema and seed data
  - [ ] 2.1 Write the complete database schema SQL
